...
<head>
<meta charset="utf-8">
<title> Politecnico de Sogamoso</title>
...
<body>
    <div class="container">
     <h1> COLEGIO POLITECNICO DE SOGAMOSO</h1>
     <hr/>
     <!--Nuevo Código-->
     <?php if(isset($_SESSION["logged"])){ ?>
		<div class="col-lg-7">
			<a href="index.php" class="btn btn-success">Inicio</a>
			<a href="crear.php" class="btn btn-primary">Crear nuevo Estudiante</a>
						
		</div>
		<div class="col-lg-5">
			<?php echo "Bienvenido ".$_SESSION["logged"]["nombre"]." ". $_SESSION["logged"]["apellidos"]; ?>
